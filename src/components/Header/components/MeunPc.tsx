...
export default function MeunPc({ menuList }: { menuList: MenuItem[] }) {
  ...
  return (
    <section className='m-auto hidden h-[44px] cursor-pointer items-center rounded-full border border-solid border-border bg-gray-400/10 p-1 font-[500] text-textColor backdrop-blur-[5px] hover:border-[#767676] lg:flex'>
      {menuList.map(item => (
        <div
