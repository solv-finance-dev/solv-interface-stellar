  ...
  (props, ref) => {
    ...
    return (
      <div
        ref={ref}
        className={cn(
          'border-input flex w-full items-stretch overflow-hidden rounded-lg border bg-transparent',
          'pr-3 transition-colors duration-150',
      ...
      >
        ...
        <Input
          ...
          disabled={disabled}
          className='min-w-0 flex-1 rounded-none rounded-l-md border-0 !bg-transparent !px-0 shadow-none focus-visible:ring-0 dark:!bg-transparent'
          {...inputProps}
          onFocus={event => {
            handleFocus(event);
          }}
