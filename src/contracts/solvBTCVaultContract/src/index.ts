 ...
 */
export type DataKey = { tag: "Admin", values: void } | { tag: "Initialized", values: void } | { tag: "Oracle", values: void } | { tag: "Treasurer", values: void } | { tag: "WithdrawVerifier", values: void } | { tag: "TokenContract", values: void } | { tag: "AllowedCurrency", values: void } | { tag: "DepositFeeRatio", values: void } | { tag: "WithdrawCurrency", values: void } | { tag: "WithdrawFeeRatio", values: void } | { tag: "WithdrawFeeReceiver", values: void } | { tag: "WithdrawRequestStatus", values: void } | { tag: "EIP712DomainName", values: void } | { tag: "EIP712DomainVersion", values: void } | { tag: "UsedRequestHash", values: readonly [Buffer] };
...
export interface SolvBTCVaultClient {
   ...
   */
  withdraw: ({ from, shares, nav, request_hash, signature }: { from: string, shares: i128, nav: i128, request_hash: Buffer, signature: Buffer }, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
...
export class SolvBTCVaultClient extends ContractClient {
  static async deploy<T = SolvBTCVaultClient>(
    ...
    { admin, token_contract, oracle, treasurer, withdraw_verifier, deposit_fee_ratio, withdraw_fee_ratio, withdraw_fee_receiver, withdraw_currency }: { admin: string, token_contract: string, oracle: string, treasurer: string, withdraw_verifier: string, deposit_fee_ratio: i128, withdraw_fee_ratio: i128, withdraw_fee_receiver: string, withdraw_currency: string },
